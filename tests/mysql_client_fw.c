...
/*
  Read and parse arguments and MySQL options from mariadb.conf
*/
...
and you are welcome to modify and redistribute it under the GPL license\n");
  ...
  print_defaults("mariadb", client_test_load_default_groups);
...
int main(int argc, char **argv)
{
  ...
  load_defaults_or_exit("mariadb", client_test_load_default_groups, &argc, &argv);
