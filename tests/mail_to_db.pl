...
sub main
{
  ...
  else
  {
    ...
    print "the mariadb.conf file. This command is available from the latest MySQL\n";
    print "distribution.\n";
  }
...
can read group [mail_to_db] from the mariadb.conf file. You may want to have db
