...
static struct my_option ibx_long_options[] =
{
	...
	"The InnoDB configuration is read from the file \"backup-mariadb.conf\".",
...
innobackupex [--compress] [--compress-threads=NUMBER-OF-THREADS] [--compress-chunk-size=CHUNK-SIZE]\n\
             ...
             [--defaults-file=MARIADB.CONF] [--defaults-group=GROUP-NAME]\n\
...
innobackupex --apply-log [--use-memory=B]\n\
             [--defaults-file=MARIADB.CONF]\n\
             [--export] [--ibbackup=IBBACKUP-BINARY]\n\
             BACKUP-DIR\n\
\n\
innobackupex --copy-back [--defaults-file=MARIADB.CONF] [--defaults-group=GROUP-NAME] BACKUP-DIR\n\
\n\
innobackupex --move-back [--defaults-file=MARIADB.CONF] [--defaults-group=GROUP-NAME] BACKUP-DIR\n\
\n\
...
InnoDB data and log files.  The MARIADB.CONF options file defines the\n\
...
in BACKUP-DIR/backup-mariadb.conf using BACKUP-DIR/ib_logfile0,\n\
and creates new InnoDB log files as specified in BACKUP-DIR/backup-mariadb.conf.\n\
...
The MARIADB.CONF options file defines the original location of the database.\n\
