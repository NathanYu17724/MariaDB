...
def test_it():
    cmd = "/home/wells/svn/iibench/py/iibench.py --db_config_file=%smy.sandbox.conf --max_rows=1000000000 --engine=tokudb --outfile=/tmp/pf_%d" % (options.sbdir, options.iterations)
    print "CMD = ", cmd
