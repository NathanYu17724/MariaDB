...
# Add options from .mariadb.conf first
...
mariadb.conf files. After that it will read the (C<~/.mytop>) file from your
...
in your C<mariadb.conf> file instead of having a separate config file.
...
Added --fullqueries and reading of .mariadb.conf
