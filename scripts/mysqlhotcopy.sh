...
Usage: $0 db_name[./table_regex/] [new_db_name | directory]
  ...
  -p, --password=#     password to use when connecting to server (if not set
                       in mariadb.conf, which is recommended)
...
one of the config files, normally /etc/mariadb.conf or your personal ~/.mariadb.conf.
(See the chapter 'mariadb.conf Option Files' in the manual.)
