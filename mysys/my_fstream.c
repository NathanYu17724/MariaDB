...
size_t my_fread(FILE *stream, uchar *Buffer, size_t Count, myf MyFlags)
{
  size_t readbytes;
  DBUG_ENTER("my_fread");
  DBUG_PRINT("mariadb",("stream: %p  Buffer %p  Count: %u  MyFlags: %lu",
...
{
  DBUG_ENTER("my_fseek");
  DBUG_PRINT("mariadb",("stream:%p  pos: %llu  whence: %d  MyFlags: %lu",
...
my_off_t my_ftell(FILE *stream, myf MyFlags __attribute__((unused)))
{
  long long pos;
  DBUG_ENTER("my_ftell");
  DBUG_PRINT("mariadb",("stream:%p  MyFlags: %lu", stream, MyFlags));
