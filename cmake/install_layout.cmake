...
# - INSTALL_SYSCONFDIR	    (mariadb.conf config file. Usually /etc or nothing)
...
SET(INSTALL_SYSCONF2DIR_RPM             "/etc/mariadb.conf.d")
#
...
SET(INSTALL_SYSCONF2DIR_DEB             "/etc/mariadb/conf.d")
#
...
IF(NOT MARIADB_UNIX_ADDR)
  SET(MARIADB_UNIX_ADDR ${INSTALL_UNIX_ADDRDIR})
ENDIF()
